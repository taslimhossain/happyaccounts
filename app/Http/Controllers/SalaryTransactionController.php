...
class SalaryTransactionController extends Controller
{
    ...
    {   return 'hello world';
        return view('expenses.salary.index');
    }
    ...
    public function create()
    {
        ...
        $expenses_cateogrys = Expenses_categories::officeActive()->get();
        $bankings          = Banking::active()->get();
        return view('expenses.salary.create', compact('expenses_cateogrys', 'bankings'));
    }
