<x-admin-layout>
  ...
  <div class="py-6 animate-bottom">
      <div class="mx-auto">
        <form method="POST" action="{{ route('project.other-transaction.store') }}" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
          @csrf
            <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              ...
              <div class="col-span-12 sm:col-span-4">
                ...
                <x-select-input name="expenses_cateogry" class="happyselect" required>
