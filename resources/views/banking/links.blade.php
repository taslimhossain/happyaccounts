<div class="mt-8">
  ...
  <x-happy-button href="{{ route( 'banking.create' ) }}"  class="mr-5 bg-indigo-600" bgColor="indigo" iconPosition="right" >
    {{ __('Add Bank Account') }}
    <x-slot name="icon">
  ...
  <x-happy-button href="{{ route( 'banking.index' ) }}"  class="mr-5 bg-slate-600" bgColor="teal" iconPosition="right" >
    {{ __('Bank List') }}
    <x-slot name="icon">
