<x-admin-layout>
    ...
    <div class="py-6">
      <div class="mx-auto">
        @include('report.bank-transaction.bank-transaction-filter')
      </div>
    </div>
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @forelse($transactions as $banking)
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-3 py-2 text-sm"> <span class="font-semibold uppercase">{{ $banking->particulars }}</span> {{ $banking->reference ? 'Reference: '.$banking->reference : null  }} </td>
                        <td class="px-3 py-2 text-sm"> {{ $banking->$banking->globalTransaction->uuid }} </td>
