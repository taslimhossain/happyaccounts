<x-print-layout>
  ...
  <div class="transaction-info text-xs pb-2">
    @foreach($projects as $projects)
      @if(!empty(request('projects_id')) &&  $projects->id == intval(request('projects_id')))
      <p class="font-semibold">Project: <span class="font-normal">{{ $projects->project_title }}</span> </p>
      @endif
    @endforeach
