<x-admin-layout>
    ...
    <div class="py-6 animate-bottom">
        <div class="mx-auto">
          <form method="POST" action="{{ route('client.store') }}" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            @csrf
              ...
              <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <x-text-input id="client_name" class="block mt-1 w-full" type="text" name="client_name" placeholder="Client Name" :value="old('client_name')" required autofocus />
                    <x-input-error :messages="$errors->get('client_name')" class="mt-2" />
                </div>
                <div class="col-span-12 sm:col-span-4">
                    <x-input-label for="phone" :value="__('Phone *')" />
                    <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" placeholder="01600000000" :value="old('phone')" required autofocus />
                    <x-input-error :messages="$errors->get('phone')" class="mt-2" />
                </div>
                <div class="col-span-12 sm:col-span-4">
                  <x-input-label for="phone_2" :value="__('Phone 2')" />
                  <x-text-input id="phone_2" class="block mt-1 w-full" type="text" name="phone_2" placeholder="01700000000" :value="old('phone_2')" autofocus />
                  <x-input-error :messages="$errors->get('phone_2')" class="mt-2" />
              </div>
                <div class="col-span-12 sm:col-span-4">
                    <x-input-label for="email" :value="__('Email *')" />
                    <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" placeholder="contact@themehappy.com" :value="old('email')" required autofocus />
              ...
              <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <x-text-input id="billing_phone" class="block mt-1 w-full" type="text" name="billing_phone" placeholder="01700000000" :value="old('billing_phone')" required autofocus />
