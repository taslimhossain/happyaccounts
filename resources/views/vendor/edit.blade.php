<x-admin-layout>
  ...
  <div class="py-6 animate-bottom">
      <div class="mx-auto">
        <form method="POST" action="{{ route('vendor.update', $vendor) }}" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
          @csrf
          @method('PATCH')
            ...
            <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <div class="col-span-12 sm:col-span-4">
                  ...
                  <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" placeholder="themehappy" :value="old('name', $vendor->name)" required autofocus />
              ...
              <div class="col-span-12 sm:col-span-4">
                  ...
                  <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" placeholder="contact@themehappy.com" :value="old('email', $vendor->email)" autofocus />
                  <x-input-error :messages="$errors->get('email')" class="mt-2" />
              </div>

              <div class="col-span-12 sm:col-span-8">
                <x-input-label for="address" :value="__('Address')" />
                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" placeholder="Theme happy, chittagong" :value="old('address', $vendor->address)" required autofocus />
            ...
            <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              <div class="col-span-12 sm:col-span-4">
                  ...
                  <x-text-input id="client" class="block mt-1 w-full" type="text" name="billing_name" placeholder="Theme Happy" :value="old('billing_name', $vendor->billing_name)" required autofocus />
              ...
              <div class="col-span-12 sm:col-span-4">
                  ...
                  <x-text-input id="billing_address" class="block mt-1 w-full" type="text" name="billing_address" placeholder="Theme happy, chittagong" :value="old('billing_address', $vendor->billing_address)" required autofocus />
              ...
              <div class="col-span-12 sm:col-span-4">
                  ...
                  <x-select-input name="status">
                    ...
                    <option value="{{ $value }}" {{ old('status', $vendor->status) != $value ?: 'selected' }}>{{ $label }}</option>
                    @endforeach
                  </x-select-input>
