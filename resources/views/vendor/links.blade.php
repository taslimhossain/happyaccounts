<div class="mt-8">
  @if( ! request()->routeIs('vendor.create') )
  <x-happy-button href="{{ route( 'vendor.create' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Create vendor') }}
    <x-slot name="icon">
  ...
  @if( ! request()->routeIs('vendor.index') )
  <x-happy-button href="{{ route( 'vendor.index' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Vendor List') }}
    <x-slot name="icon">
