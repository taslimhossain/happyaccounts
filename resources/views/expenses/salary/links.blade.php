<div class="mt-8">
  @if( ! request()->routeIs('expenses.salary.index') )
  <x-happy-button href="{{ route( 'expenses.salary.index' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
  ...
  @if( ! request()->routeIs('expenses.salary.create') )
  <x-happy-button href="{{ route( 'expenses.salary.create' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Pay salary') }}
    <x-slot name="icon">
