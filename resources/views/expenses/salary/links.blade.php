<div class="mt-8">
  @if( ! request()->routeIs('client.create') )
  <x-happy-button href="{{ route( 'client.create' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Create client') }}
    <x-slot name="icon">
  ...
  <x-happy-button href="{{ route( 'client.index' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Client List') }}
    <x-slot name="icon">
