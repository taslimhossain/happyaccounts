<x-admin-layout>
    <x-slot:page_title>
      <span class="text-gray-500"> Client Details: </span> {{ __( $client->client_name) }} 
    </x-slot>
    <x-slot:pages_links>
          ...
          <div class="text-sm px-4 py-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
              ...
              <div class="grid grid-cols-3 gap-3 md:gap-5 xl:gap-6 lg:gap-6">
                <div class="flex flex-col">
                  <h4 class="font-semibold text-gray-600 dark:text-gray-300"> Client Name </h4>
                  <p class="text-gray-600 dark:text-gray-400">{{ $client->client_name }}</p>
                </div>
                <div class="flex flex-col">
                ...
                <div class="flex flex-col">
                  ...
                  <p class="text-gray-600 dark:text-gray-400">{{ $client->phone_2 }}</p>
                </div>
                <div class="flex flex-col">
              ...
              <div class="grid grid-cols-3 gap-3 md:gap-5 xl:gap-6 lg:gap-6">
                <div class="flex flex-col">
                  ...
                  <p class="text-gray-600 dark:text-gray-400">{{ $client->billing_name }}</p>
                </div>
                <div class="flex flex-col">
                ...
                <div class="flex flex-col col-span-3">
                  ...
                  <p class="text-gray-600 dark:text-gray-400">{{ $client->description }}</p>
                </div>
                <div class="flex flex-col">
                  <h4 class="font-semibold text-gray-600 dark:text-gray-300"> Account status </h4>
                  <p class="text-gray-600 dark:text-gray-400">{{ \App\Helpers\Constant::getRowStatus()[$client->status] }}</p>
                </div>
              </div>
          </div>
