<div class="mt-8">
  ...
  @if( ! request()->routeIs('expenses.office-categorie.list') )
  <x-happy-button href="{{ route( 'expenses.office-categorie.list' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
