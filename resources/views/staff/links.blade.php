<div class="mt-8">
  ...
  @if( ! request()->routeIs('staff.create') )
  <x-happy-button href="{{ route( 'staff.create' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Add staff') }}
    <x-slot name="icon">
  ...
  @if( ! request()->routeIs('staff.index') )
  <x-happy-button href="{{ route( 'staff.index' ) }}"  class="mr-5 bg-lime-600" bgColor="lime" iconPosition="right" >
    {{ __('Staff List') }}
    <x-slot name="icon">
