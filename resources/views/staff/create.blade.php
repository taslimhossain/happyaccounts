            ...
            @csrf
              <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" placeholder="Staff Name" :value="old('name')" required autofocus />
                ...
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <x-text-input id="end_date" class="happydate block mt-1 w-full" type="text" name="end_date" placeholder="dd/mm/yyyy" :value="old('end_date')" autofocus />
              ...
              <div class="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" placeholder="staff@themehappy.com" :value="old('email')" autofocus />
